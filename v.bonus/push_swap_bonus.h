...
int			ft_sa_bonus(int *i, int sz);
int			ft_sb_bonus(int *i, int sz);
int			ft_ss_bonus(int *i, int *j, int szi, int szj);
int			ft_pa_bonus(t_st *in);//cuenta movimientos pa necesarios para cada caso
int			ft_pb_bonus(t_st *in);//cuenta movimientos pb necesarios para cada caso
