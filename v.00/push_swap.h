...
int		ft_max(t_st *in, t_opt *mov);//max del stack a 
...
int		ft_min(t_st *in, t_opt *min);//encuentra el minimo movimiento y su posicion
...
int		ft_put_max(t_st *in, t_opt *mov);//en b poner el mximo en la posicion 0
